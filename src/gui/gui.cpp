...
namespace cursed
{
    ...
    void GUI::render( TCODConsole *console, GUI *focused_gui )
    {
        ...
        // Don't waste your time if there's no text
        if ( text != "" )
        {
        ...
        {
            child->render( console, focused_gui );
        }
    }
    ...
    void GUIButton::render( TCODConsole *console, GUI *focused_gui )
    {
        GUI::render( console, focused_gui );
    }
};
